...
I’m a passionate software developer who loves solving real-world problems through clean, scalable code.  
I work across **full-stack development**, **backend systems**, and **AI-powered tools**, with a strong foundation in **Data Structures & Algorithms**.

I enjoy building products from scratch, experimenting with new technologies, and continuously sharpening my problem-solving skills through platforms like **LeetCode**.
...
### 🧠 **SprintPlanner**
> **AI-powered 4-Week Sprint Planning System**

- Converts raw ideas into **structured execution plans**
- Uses **multi-stage agentic AI**
- Inspired by *The Personal MBA* & startup best practices  
- Focus on **customer clarity, validation & execution**

**Tech:** Next.js · Python · LangChain · OpenAI · PostgreSQL · Tailwind

---

### 🎟️ **Ticksy – Smart Booking Platform**
> Ticket booking & payment system with AI-assisted workflows
...
**Tech:** Java · Spring Boot · Next.js · SQL · Docker
...
✨ *“Turning ideas into executable systems, one sprint at a time.”*
